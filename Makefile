...
# Lint & format
.PHONY: fmt lint lint.imports lint.filesize lint.complexity lint.complexity.update lint.migrations fix precommit test coverage coverage.diff visual visual.headed
fmt:
	ruff format .
