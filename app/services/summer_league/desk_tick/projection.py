...
projection tables this class exclusively owns:
  ...
  5. **commentary** (#524) -- all eight #520 detectors per graded player, each
     ...
     :mod:`app.services.summer_league.desk_tick.commentary`.
...
from app.services.summer_league.desk_grades import GradeRow, grade_players_bulk
...
from app.services.summer_league.desk_tick.commentary import (
