...
:class:`~app.services.summer_league.desk_facts.Fact` records. Stage 2
(`app.services.summer_league.desk_selection`, #518) picks the angle: dedup,
...
**Gated grades: hedge, don't refuse.** A :attr:`~app.services.summer_league.desk_grades.GradeRow.gated`
...
prefixed mirrors -- see `app.services.summer_league.cohort_baselines`
...
:meth:`~app.services.summer_league.desk_facts.Fact.to_dict` plus its
...
from app.services.summer_league.desk_selection import Surface, select_facts
...
def build_facts_payload(
    ...
    not equality -- :class:`~app.services.summer_league.desk_facts.Fact` is
