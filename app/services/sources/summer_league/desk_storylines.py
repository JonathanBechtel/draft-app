...
from app.services.sources.summer_league.desk_facts import (
    detect_streak as _facts_detect_streak,
)
...
from app.services.sources.summer_league.desk_grades import GradeRow, percentile_of_value
...
def detect_streak(
    *,
    ...
    :class:`~app.services.sources.summer_league.desk_facts.Fact` into a
