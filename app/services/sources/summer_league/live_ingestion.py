...
ingestor (:mod:`app.services.sources.summer_league.raw_ingestion`) either reuses
...
:attr:`~app.services.sources.summer_league.raw_ingestion.RawIngestionOptions.game_ids`
...
class LiveIngestionReport:
    ...
    Attributes:
        ...
        required_errors: The subset of ``errors`` that must block freshness --
            ...
            ``boxscorescoringv2`` --
            :func:`~app.services.sources.summer_league.raw_ingestion.is_required_game_endpoint`).
...
def refresh_selected_games(
    ...
    *,
    ...
    :meth:`~app.services.sources.summer_league.raw_ingestion.SummerLeagueRawIngestor.fetch_year_league`
    ...
    (:class:`~app.services.sources.summer_league.raw_ingestion.SummerLeagueRequiredGamelogError`)
