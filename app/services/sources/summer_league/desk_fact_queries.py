...
`app.services.sources.summer_league.desk_facts` (#520) deliberately built eight
...
(:class:`~app.services.sources.summer_league.desk_facts.CohortPeer`,
:class:`~app.services.sources.summer_league.desk_facts.GameLine`, etc.). Only
``detect_percentile`` has an input (:class:`~app.services.sources.summer_league.desk_grades.GradeRow`)
...
* :func:`~app.services.sources.summer_league.cohort_baselines.blend_event_aggregates`
  / :func:`~app.services.sources.summer_league.cohort_baselines.cohort_key_for` (#502)
...
* :func:`~app.services.sources.summer_league.desk_grades.percentile_of_value` (#503),
  ...
  grains.
* :func:`~app.services.sources.summer_league.metrics.game_score_from_row` --
...
def cohort_peers(
    ...
    Feeds :func:`~app.services.sources.summer_league.desk_facts.detect_cohort_rank`.
    """
    return [
...
def club_members_clearing(
    ...
    *,
    ...
    Feeds :func:`~app.services.sources.summer_league.desk_facts.detect_count_club`.
    """
...
def most_recent_prior_holder(
    ...
    *,
    ...
    Feeds :func:`~app.services.sources.summer_league.desk_facts.detect_first_since`.
    """
...
async def fetch_debut_baselines(
    ...
    :func:`~app.services.sources.summer_league.desk_facts.detect_debut_vs_bar`'s
...
async def fetch_game_baselines(
    ...
    ``baseline_by_player`` and :func:`~app.services.sources.summer_league.desk_facts.detect_streak`'s
...
async def fetch_tonight_field(
    ...
    Feeds :func:`~app.services.sources.summer_league.desk_facts.detect_leads_field`.
...
async def fetch_prior_events(
    ...
    :func:`~app.services.sources.summer_league.desk_facts.detect_self_delta`.
...
async def fetch_current_event_gp(
    ...
    argument of :func:`~app.services.sources.summer_league.desk_facts.detect_self_delta`.
    """
    if not player_ids:
        return {}
...
async def fetch_debut_status(
    ...
    :func:`~app.services.sources.summer_league.desk_facts.detect_debut_vs_bar`.
...
async def fetch_game_lines(
    ...
    *,
    ...
    (:func:`~app.services.sources.summer_league.desk_facts.detect_streak` via
