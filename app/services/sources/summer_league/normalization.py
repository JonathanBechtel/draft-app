...
async def find_incomplete_team_box_game_ids(
    ...
    ``app.services.sources.summer_league.metrics``) even once real box scores exist.
...
async def refresh_competition_date_window(
    ...
    (:func:`app.services.sources.summer_league.scoreboard_ingest.upsert_scoreboard_games`)
...
def resolve_game_status(
    *,
    ...
    (``app.services.sources.summer_league.live_ingestion``) can legitimately force a
