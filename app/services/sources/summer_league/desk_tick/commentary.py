...
`app.services.sources.summer_league.desk_tick.projection` stays a readable
...
from app.services.sources.summer_league.cohort_baselines import cohort_key_for
...
from app.services.sources.summer_league.desk_storylines import SlateRow
from app.services.sources.summer_league.desk_tick.shared import ROSTER_ACTIVE_STATUSES
...
async def game_roster_player_ids(
    ...
    :func:`~app.services.sources.summer_league.desk_commentary.persist_slate_facts_bulk`.
    """
    games = (
        (
            await db.execute(
