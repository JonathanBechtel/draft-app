...
* :class:`~app.services.sources.summer_league.nba_stats_client.NBAStatsClient` — the
...
async def upsert_scoreboard_games(
    ...
    (:func:`app.services.sources.summer_league.normalization.refresh_competition_date_window`)
