...
`app.services.sources.summer_league.desk_storylines.select_quiet_slate_hero` (the pure
...
async def _resolve_window_state(
    ...
    **Query budget (#548).** Exactly 3 queries in the common case (an
    ...
    `~app.services.sources.summer_league.scoreboard_ingest.resolve_target_competitions`
...
# see `app.services.sources.summer_league.metrics`, which stores these `None`
