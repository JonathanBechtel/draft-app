...
MERGE_PLANS: tuple[MergePlan, ...] = (
    ...
    # --- 2026-05-15 nbadraft.net first-round audit ---
    MergePlan(
        source_rank=3,
        source_name="Cameron Boozer",
        keep_id=5653,
        discard_ids=(5623,),
        canonical_display_name="Cameron Boozer",
        canonical_school="Duke",
        source_school_raw="Duke",
        draft_year=2026,
        reason="Merge 'Cam Boozer' nickname stub into canonical Cameron Boozer row (Cayden Boozer/5801 is his twin — untouched).",
    ),
    MergePlan(
        source_rank=6,
        source_name="Keaton Wagler",
        keep_id=5690,
        discard_ids=(6039,),
        canonical_display_name="Keaton Wagler",
        canonical_school="Illinois",
        source_school_raw="Illinois",
        draft_year=2026,
        reason="Merge surname-only stub 'Wagler' (Illinois, 2026) into canonical Keaton Wagler row.",
    ),
    MergePlan(
        source_rank=9,
        ...
        source_school_raw="Tennessee",
        draft_year=2026,
        reason="Merge 'Nathaniel Ament' (no school, 2026) into canonical Nate Ament row; preserve 'Nathaniel Ament' as alias.",
    ),
    MergePlan(
        source_rank=13,
        source_name="Yaxel Lendeborg",
        keep_id=1691,
        discard_ids=(6040,),
        canonical_display_name="Yaxel Lendeborg",
        canonical_school="Michigan",
        source_school_raw="Michigan",
        draft_year=2026,
        reason="Merge surname-only stub 'Lendeborg' (Michigan, 2026) into Yaxel Lendeborg; update draft_year 2025 -> 2026 (withdrew from 2025 draft, projected 2026).",
    ),
    MergePlan(
        source_rank=15,
        source_name="Chris Cenac Jr.",
        ...
        source_school_raw="Houston",
        draft_year=2026,
        reason="Merge 'Christopher Cenac Jr.' (no school, 2026) into canonical Chris Cenac Jr. row; preserve as alias. (Shelton Cenac/5662 is a different person — untouched.)",
    ),
    MergePlan(
        source_rank=27,
        source_name="Koa Peat",
        keep_id=5513,
        discard_ids=(6042,),
        canonical_display_name="Koa Peat",
        canonical_school="Arizona",
        source_school_raw="Arizona",
        draft_year=2026,
        reason="Merge surname-only stub 'Peat' (Arizona, 2026) into canonical Koa Peat row.",
    ),
)
