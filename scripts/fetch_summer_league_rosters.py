...
The script fetches the venue landing page, enumerates teams, fetches each
per-team roster page, parses the __NEXT_DATA__ JSON blob, and writes one
deterministic raw JSON snapshot per (year, league_id) run under:
